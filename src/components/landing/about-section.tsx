  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-black px-6 pb-10 pt-32 md:pb-14 md:pt-44">
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          <span className="font-display italic text-white/60">Ваши модели</span> и данные —{" "}
          <br className="hidden md:block" />
          <span className="font-display italic text-white/60">на вашем железе, под вашим контролем.</span>
        </motion.h2>
      </div>
    </section>
  );
