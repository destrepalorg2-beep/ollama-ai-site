    ...
    <div className="min-h-screen bg-[#0f0f1e] text-white">
      ...
      <main className="max-w-3xl mx-auto p-6 space-y-12 py-12">
        <section className="text-center space-y-4">
          ...
          <p className="text-gray-400 text-lg max-w-xl mx-auto">{t("about.heroLead")}</p>
        </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 bg-[#1a1a2e] rounded-3xl border border-transparent hover:border-[#7c3aed] transition-all group">
            ...
            <h3 className="text-xl font-semibold mb-2">{t("about.privacyTitle")}</h3>
            <p className="text-gray-400 text-sm leading-relaxed">{t("about.privacyDesc")}</p>
          </div>
          ...
          <div className="p-6 bg-[#1a1a2e] rounded-3xl border border-transparent hover:border-[#7c3aed] transition-all group">
            ...
            <h3 className="text-xl font-semibold mb-2">{t("about.speedTitle")}</h3>
            <p className="text-gray-400 text-sm leading-relaxed">{t("about.speedDesc")}</p>
          </div>
          ...
          <div className="p-6 bg-[#1a1a2e] rounded-3xl border border-transparent hover:border-[#7c3aed] transition-all group">
            ...
            <h3 className="text-xl font-semibold mb-2">{t("about.flexTitle")}</h3>
            <p className="text-gray-400 text-sm leading-relaxed">{t("about.flexDesc")}</p>
          </div>
          ...
          <div className="p-6 bg-[#1a1a2e] rounded-3xl border border-transparent hover:border-[#7c3aed] transition-all group">
            ...
            <h3 className="text-xl font-semibold mb-2">{t("about.crossTitle")}</h3>
            <p className="text-gray-400 text-sm leading-relaxed">{t("about.crossDesc")}</p>
          </div>
        </div>
        ...
        <section className="bg-gradient-to-br from-[#7c3aed]/10 to-transparent p-8 rounded-3xl border border-[#7c3aed]/20 text-center">
          ...
          <p className="text-gray-400 mb-6">{t("about.ctaLead")}</p>
          <button
